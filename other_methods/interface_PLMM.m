...
% wrapper for the PLMM  algorithm
% 
% Input: data   - data cube of observed image
%        A_init - initialization for the abundance maps
%        M0     - Initialization for the average EM matrix
%        alpha, beta, gamma - regularization parameters
% 
% Output: A_mtx_colord - estimated abundance maps
%         dM_lexico2   - additive perturbations over the average endmember matrix
%         M_tot        - endmember matrices for each pixel
