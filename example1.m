% =========================================================================
% First example with synthetic data for endmember variability (scaling factors)
% 
...
% load dataset
if SNR == 20
    load('DATA/data_ex1_20db.mat')
elseif SNR == 30
    load('DATA/data_ex1_30db.mat')
elseif SNR == 40
    load('DATA/data_ex1_40db.mat')
end
...
%print(['examples/estim_abundances_DC1_SNR' num2str(SNR) '_tght'],'-depsc')
